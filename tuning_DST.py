...
def load_DST_data():
    data = []
    lines = open("/home/ec2-user/in-context-DST/gpt-neo-v1.jsonl").readlines()
    for line in lines:
        dp = json.loads(line)
        dp["task"] = "DST"
        data.append(dp)
...
if __name__=='__main__':
    ...
    parser.add_argument("--gpt2", type=str, default="EleutherAI/gpt-neo-2.7B")
